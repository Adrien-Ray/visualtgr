...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-sm-12 content">
            ...
            <p>Note : Lorsqu’une feuille de style est attachée à un élément link comportant une requếte média, cette feuille de style sera toujours téléchargée, même si la requête renvoie false. Toutefois, le contenu de cette feuille n’est pas appliquée tant que le résultat de la requête ne devient pas true.</p>
