...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-sm-12 content">
            ...
            <i>chloev 2 avril 2021- catégorie Les métiers du web</i>
            <br>
            ...
            <h2>Les catégories de développeur web</h2>
                ...
                <p>Il se charge de la conception du site web côté client et écrit le code nécessaire pour l’implémenter sur le web. Il utilise les différents langages côté client :</p>
                <ul>
                    <li>HTML</li>
                    <li>CSS</li>
                    <li>JavaScript</li>
                </ul>
                <p>Il peut également réaliser :</p>
                <ul>
                ...
                <p>Il effectue la réalisation technique et le développement informatique d’applications pour mobiles, smartphones et autres tablettes. Ses responsabilités sont de tenir compte des spécificités de l’affichage des applications sur les différents outils. Pour cela, il utilise différents langages selon les systèmes d’exploitation :</p>
                <ul>
                    <li>C / Objective C / HTML5 (iOS)</li>
                    <li>C / C# / PHP / Java (Android)</li>
                </ul>
                <p>Deux possibilités s’offrent à lui :</p>
                <ul>
